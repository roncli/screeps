        ...
        switch (resource) {
            ...
            case RESOURCE_CATALYZED_UTRIUM_ACID:
                visual
                    ...
                    .text(resource, x + 0.725 * size, y + 0.175 * size, {color: "#006181", font: 0.625 * size, opacity: style.opacity});
                break;
            ...
            case RESOURCE_CATALYZED_KEANIUM_ACID:
                visual
                    ...
                    .text(resource, x + 0.725 * size, y + 0.175 * size, {color: "#371383", font: 0.625 * size, opacity: style.opacity});
                break;
            ...
            case RESOURCE_CATALYZED_LEMERGIUM_ACID:
                visual
                    ...
                    .text(resource, x + 0.725 * size, y + 0.175 * size, {color: "#236144", font: 0.625 * size, opacity: style.opacity});
                break;
            ...
            case RESOURCE_CATALYZED_ZYNTHIUM_ACID:
                visual
                    ...
                    .text(resource, x + 0.725 * size, y + 0.175 * size, {color: "#5D4C2E", font: 0.625 * size, opacity: style.opacity});
                break;
            ...
            case RESOURCE_CATALYZED_GHODIUM_ACID:
                visual
                    ...
                    .text(resource, x + 0.725 * size, y + 0.175 * size, {color: "#666666", font: 0.625 * size, opacity: style.opacity});
                break;
