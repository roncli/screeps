...
Rally.prototype.run = function(creep) {
    ...
    Pathing.moveTo(creep, this.rallyPoint, creep.room.name === this.rallyPoint.roomName || (this.rallyPoint.pos && creep.room.name === this.rallyPoint.pos.roomName) ? (this.range || 0) : 20);
