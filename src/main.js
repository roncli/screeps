    ...
    static balanceEnergy() {
        ...
        if (rooms.length > 1) {
            ...
            _.forEach(rooms, (room, index) => {
                const {[rooms.length - index - 1]: {name: otherRoomName, storage: {store: {[RESOURCE_ENERGY]: otherRoomStorageEnergy}}, terminal: otherRoomTerminal, terminal: {store: {[RESOURCE_ENERGY]: otherRoomTerminalEnergy}}}} = Object.assign({}, rooms),
