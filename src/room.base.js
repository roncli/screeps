...
class RoomBase extends RoomEngine {
    ...
    tasks() {
        ...
        this.tasks = {
            ...
            terminalsCollectEnergy: terminal && (!terminal.my || terminalEnergy > 10000 || terminalEnergy >= 5000 && (!roomMemory.buyQueue || !storage || store[RESOURCE_ENERGY] < Memory.marketEnergy || Cache.credits < Memory.minimumCredits)),
